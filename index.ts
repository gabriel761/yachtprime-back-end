...
app.use(cors({ origin: ['http://localhost:3000', 'https://yacht-prime-dashboard-mvy5.vercel.app', 'https://yacht-prime-front-end.vercel.app', "https://yacht-prime-dashboard-mvy5.vercel.app/"] }));
